...
const (
	...
	User_GetLoginLog_FullMethodName     = "/user.User/GetLoginLog"
	User_DeleteLoginLog_FullMethodName  = "/user.User/DeleteLoginLog"
...
type UserClient interface {
	...
	GetLoginLog(ctx context.Context, in *GetLoginLogRequest, opts ...grpc.CallOption) (*LoginLogResponse, error)
	DeleteLoginLog(ctx context.Context, in *DeleteLoginLogRequest, opts ...grpc.CallOption) (*Empty, error)
...
func (c *userClient) GetLoginLog(ctx context.Context, in *GetLoginLogRequest, opts ...grpc.CallOption) (*LoginLogResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userClient) DeleteLoginLog(ctx context.Context, in *DeleteLoginLogRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, User_DeleteLoginLog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	GetLoginLog(context.Context, *GetLoginLogRequest) (*LoginLogResponse, error)
	DeleteLoginLog(context.Context, *DeleteLoginLogRequest) (*Empty, error)
...
func (UnimplementedUserServer) GetLoginLog(context.Context, *GetLoginLogRequest) (*LoginLogResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetLoginLog not implemented")
}
func (UnimplementedUserServer) DeleteLoginLog(context.Context, *DeleteLoginLogRequest) (*Empty, error) {
...
func _User_DeleteLoginLog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteLoginLogRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).DeleteLoginLog(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_DeleteLoginLog_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).DeleteLoginLog(ctx, req.(*DeleteLoginLogRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _User_UpdateUserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).UpdateUserInfo(ctx, req.(*UpdateUserInfoReqest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _User_ChangePassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).ChangePassword(ctx, req.(*ChangePassWdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _User_DeleteLoginLog_Handler,
		},
		{

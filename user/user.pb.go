...
func (x *UpdateUserInfoReqest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
const file_user_proto_rawDesc = "" +
	...
	"walletAddr\x12,\n" +
	"\x12user_referral_code\x18\x05 \x01(\tR\x10userReferralCode\x12#\n" +
	"\rreferral_code\x18\x06 \x01(\tR\freferralCode\"o\n" +
	"\x14UpdateUserInfoReqest\x12\x1a\n" +
	"\bnickname\x18\x01 \x01(\tR\bnickname\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\x12\x1f\n" +
	"\vwallet_addr\x18\x03 \x01(\tR\n" +
	"walletAddr\"\x18\n" +
	"\x16UpdateUserInfoResponse2\x83\x02\n" +
	"\x04User\x129\n" +
	...
	"\x0eUpdateUserInfo\x12\x1a.user.UpdateUserInfoReqest\x1a\x1c.user.UpdateUserInfoResponseB\bZ\x06./userb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	5, // 6: user.User.GetUserInfo:output_type -> user.GetUserInfoResponse
	7, // 7: user.User.UpdateUserInfo:output_type -> user.UpdateUserInfoResponse
